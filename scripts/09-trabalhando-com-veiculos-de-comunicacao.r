...
writexl::write_xlsx(
  media_tweets,
  "dados_output/09-trabalhando-com-veiculos-de-comunicacao/tweets_jornalisticos.xlsx"
)
...
write_xlsx(
  media_tweets_categorizada,
  'dados_output/09-trabalhando-com-veiculos-de-comunicacao/media_tweets_categorizada.xlsx'
)



media_tweets_tab_1 <- media_tweets_categorizada |>
  dplyr::select(grupos_de_midia,
                veiculos,
                proximidade_ideologica_grupos_de_midia) |>
  dplyr::arrange(grupos_de_midia)

write_xlsx(
  media_tweets_tab_1,
  'dados_output/09-trabalhando-com-veiculos-de-comunicacao/media_tweets_tab_1.xlsx'
)
...
write_xlsx(
  media_tweets_tab_2,
  'dados_output/09-trabalhando-com-veiculos-de-comunicacao/media_tweets_tab_2.xlsx'
)
